<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
String path = request.getContextPath(); //返回当前页面所在的应用的名字
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/"; //request.getSchema()可以返回当前页面使用的协议，http 或是 https
%>
<html>
<head>
<title>发布招募</title>
...
<div id="main">
	...
	<div id="text">
        <div id="text2">
        	<h1>发布招募</h1>
            <div id="tx2">
            	<img name="publishImg" src="images/志愿者.jpg" />
